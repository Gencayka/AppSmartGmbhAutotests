...
/**
 * Enum holds all the possible options for all the products in different languages
 * <br>(yeah I know that all the label other then about size are in Deutsch but I assume it
 * shouldn't be like that and is supposed to be fixed)
 */
@AllArgsConstructor
