...
public class UISafariTests extends UITests {
    private Logger logger = LoggerFactory.getLogger(UISafariTests.class.getSimpleName());

    @BeforeClass
    public void beforeClass(){
        closeWebDriver();
        Configuration.browser = Browser.APPLE_SAFARI.getWebDriverName();
        open("");
    }

    @DataProvider
    public Object[][] discountCalDP(){
        return testDataHolder.getDiscountCalculationSpecificBrowserTestData(Browser.APPLE_SAFARI);
    }
